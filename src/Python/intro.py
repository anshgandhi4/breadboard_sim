...
class Intro(Frame):
    def __init__(self, master):
        ...
        Label(self, bg = "white", font = ("Arial", 18), text = "Welcome to Breadboard Simulator").grid(row = 0, column = 0)
        ...
        Label(self, bg = "white", font = ("Arial", 9), text = "Below you can see what the breadboard will look like when the simulator first opens.\n"
        ...
        "Once you have placed all your components, press run and see your creation come to life.").grid(row = 4, column = 0)
